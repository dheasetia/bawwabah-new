    ...
    <div class="toolbar py-5 py-lg-15" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
            ...
            <div class="page-title d-flex flex-column me-3">
                <!--begin::Title-->
                <h1 class="d-flex text-white fw-bolder my-1 fs-3">داشبورد</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-white opacity-75">داشبورد</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
                        ...
                        <tr>
                            ...
                            <td class="d-flex align-items-center">
                                ...
                                <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                    <a href="../../demo2/dist/apps/user-management/users/view.html">
                                        <div class="symbol-label">
                                            <img src="{{asset("assets/media/avatars/150-26.jpg")}}" alt="Max Smith" class="w-100" />
                                        </div>
                                    </a>
                                </div>
                                <!--end::Avatar-->
                        ...
                        <tr>
                            ...
                            <td class="d-flex align-items-center">
                                ...
                                <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                    <a href="../../demo2/dist/apps/user-management/users/view.html">
                                        <div class="symbol-label">
                                            <img src="{{asset("assets/media/avatars/150-4.jpg")}}" alt="Sean Bean" class="w-100" />
                                        </div>
                                    </a>
                                </div>
                                <!--end::Avatar-->
                        ...
                        <tr>
                            ...
                            <td class="d-flex align-items-center">
                                ...
                                <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                    <a href="../../demo2/dist/apps/user-management/users/view.html">
                                        <div class="symbol-label">
                                            <img src="{{asset("assets/media/avatars/150-15.jpg")}}" alt="Brian Cox" class="w-100" />
                                        </div>
                                    </a>
                                </div>
                                <!--end::Avatar-->
                        ...
                        <tr>
                            ...
                            <td class="d-flex align-items-center">
                                ...
                                <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                    <a href="../../demo2/dist/apps/user-management/users/view.html">
                                        <div class="symbol-label">
                                            <img src="{{asset("assets/media/avatars/150-8.jpg")}}" alt="Francis Mitcham" class="w-100" />
                                        </div>
                                    </a>
                                </div>
                                <!--end::Avatar-->
                        ...
                        <tr>
                            ...
                            <td class="d-flex align-items-center">
                                ...
                                <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                    <a href="../../demo2/dist/apps/user-management/users/view.html">
                                        <div class="symbol-label">
                                            <img src="{{asset("assets/media/avatars/150-6.jpg")}}" alt="Dan Wilson" class="w-100" />
                                        </div>
                                    </a>
                                </div>
                                <!--end::Avatar-->
                        ...
                        <tr>
                            ...
                            <td class="d-flex align-items-center">
                                ...
                                <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                    <a href="../../demo2/dist/apps/user-management/users/view.html">
                                        <div class="symbol-label">
                                            <img src="{{asset("assets/media/avatars/150-7.jpg")}}" alt="Ana Crown" class="w-100" />
                                        </div>
                                    </a>
                                </div>
                                <!--end::Avatar-->
                        ...
                        <tr>
                            ...
                            <td class="d-flex align-items-center">
                                ...
                                <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                    <a href="../../demo2/dist/apps/user-management/users/view.html">
                                        <div class="symbol-label">
                                            <img src="{{asset("assets/media/avatars/150-17.jpg")}}" alt="John Miller" class="w-100" />
                                        </div>
                                    </a>
                                </div>
                                <!--end::Avatar-->
